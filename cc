---
- name: Manage AWS ACM Certificate
  hosts: localhost
  gather_facts: false
  tasks:
    ...
    - name: Find the certificate by domain name
      ...
      when: "'gitlab.dev-frhns.private' in item.domain_name"
    ...
    - name: Import Certificate into Java Keystore
      vars:
        ...
        keystore_path: "C:\\Program Files\\ServiceNow MID Server mid-api01-west-dev\\agent\\jre\\lib\\security\\cacerts"
      ...
      block:
        ...
        - name: Import certificate into Java Keystore
          command: >
            "C:\\Program Files\\ServiceNow MID Server mid-api01-west-dev\\agent\\jre\\bin\\keytool.exe"
